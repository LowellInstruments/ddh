...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_testmode = QtWidgets.QLabel(self.tab)
        ...
        self.lbl_testmode.setTextFormat(QtCore.Qt.PlainText)
        self.lbl_testmode.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.lbl_summary_dl = QtWidgets.QLabel(self.tab)
        ...
        self.lbl_antenna = QtWidgets.QLabel(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_9.addWidget(self.lbl_antenna)
        ...
        self.line_sn = QtWidgets.QLineEdit(self.tab_setup)
        ...
        self.cb_skip_in_port = QtWidgets.QComboBox(self.tab_setup)
        ...
        self.btn_close_wo_save = QtWidgets.QPushButton(self.tab_setup)
...
"font: 19pt \"DejaVu Sans\";")
        ...
        self.btn_sms = QtWidgets.QPushButton(self.tab_more_info)
        ...
        self.lbl_box_sn = QtWidgets.QLabel(self.tab_more_info)
        self.lbl_box_sn.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lbl_box_sn.setText("")
        self.lbl_box_sn.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.chk_b_maps = QtWidgets.QCheckBox(self.tab_advanced)
        ...
        self.cbox_scf = QtWidgets.QComboBox(self.tab_advanced)
        ...
        self.chk_ow = QtWidgets.QCheckBox(self.tab_advanced)
        ...
        self.cb_g_switch_tp = QtWidgets.QComboBox(self.tab_graph)
        ...
        self.btn_map_next = QtWidgets.QPushButton(self.tab_map)
        ...
        self.tab_trawls = QtWidgets.QWidget()
        self.tab_trawls.setObjectName("tab_trawls")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.tab_trawls)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.cb_trawls_logger = QtWidgets.QComboBox(self.tab_trawls)
        self.cb_trawls_logger.setObjectName("cb_trawls_logger")
        self.horizontalLayout_18.addWidget(self.cb_trawls_logger)
        self.btn_trawls_prev_file = QtWidgets.QPushButton(self.tab_trawls)
        self.btn_trawls_prev_file.setObjectName("btn_trawls_prev_file")
        self.horizontalLayout_18.addWidget(self.btn_trawls_prev_file)
        self.btn_trawls_last_file = QtWidgets.QPushButton(self.tab_trawls)
        self.btn_trawls_last_file.setObjectName("btn_trawls_last_file")
        self.horizontalLayout_18.addWidget(self.btn_trawls_last_file)
        ...
        self.tabs.addTab(self.tab_trawls, "")
